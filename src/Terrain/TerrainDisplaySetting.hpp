...
/**
 * Map Display → Terrain: shared catalog and get/set for global profile
 * and live MapSettings.  Per-page override storage stays in
 * #PageSettingOverrides; use #PageSettingGet / #PageSettingSet for scope.
 */
namespace TerrainDisplaySetting {

struct Bundle {
  TerrainRendererSettings terrain;
  bool topography_enabled = true;
};
